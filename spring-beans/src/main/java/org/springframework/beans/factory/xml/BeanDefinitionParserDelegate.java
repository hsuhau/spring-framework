...
public class BeanDefinitionParserDelegate {
	 ...
	 * {@link org.springframework.beans.factory.parsing.ProblemReporter}.
	 *
	 * <p>解析提供的<bean>元素。 如果解析过程中出现错误，则可能返回null 。 错误报告给org.springframework.beans.factory.parsing.ProblemReporter 。</p>
	 */
	@Nullable
	 ...
	 * <p>解析 bean 定义本身，而不考虑名称或别名。 如果在解析 bean 定义期间出现问题，则可能返回null 。</p>
	 */
	@Nullable
	//todo hsuhau 然后，我们再看看怎么根据配置创建 BeanDefinition 实例的：
